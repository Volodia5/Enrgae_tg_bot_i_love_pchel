...
public class ServiceManager
{
    ...
    public ServiceManager()
    {
        ...
        _methods[States.TournamentMenu.ProcessInputTournamentData] =
            tournamentMenuService.ProcessInputTournamentData;
    ...
    public BotMessage ProcessBotUpdate(string textData, TransmittedData transmittedData)
    {
        if (textData == SystemStringsStorage.CommandReset)
        {
            if (transmittedData.State == States.SearchTeammateMenu.UpdateName ||
                ...
                transmittedData.State == States.SearchTeammateMenu.UpdatePosition || transmittedData.State ==
                States.SearchTeammateMenu.QuestionnaireUpdateCreateConfirmation)
            {
            ...
            if (transmittedData.ChatId == 994645175)
            {
